    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="px-6 py-16 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { step: "01", title: "Browse Events", desc: "Explore events on Axile with referral rewards enabled." },
            { step: "02", title: "Generate Your Link", desc: "Get a unique referral link or QR code for any event." },
            { step: "03", title: "Earn Commissions", desc: "Earn money every time someone registers via your link." },
          ].map((item) => (
            <div key={item.step} className="flex flex-col gap-3 p-6 rounded-xl border border-border bg-card">
